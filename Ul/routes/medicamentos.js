...
router.post('/pendientes', (req, res) => {
    const {
        ...
        tipocontrato, codigodiagnostico, diagnostico, plansos, fechaformula, laboratorio
    } = req.body;
...
const values = [
    ...
    data.tipocontrato, data.codigodiagnostico, data.diagnostico, data.plansos, data.fechaformula, data.laboratorio
];
